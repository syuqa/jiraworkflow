...
## Migrate databases
`docker-compose run --rm backend jiraworkflow/manage.py migrate` or `make migrate`.

## Collect static files
`docker-compose run --rm backend jiraworkflow/manage.py collectstatic --no-input'` or `make collectstatic`.
